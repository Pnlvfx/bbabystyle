    ...
    <div className="flex min-h-[calc(100vh_-_48px)] flex-col">
      <div className="z-[3]">
        <div className="flex h-24 justify-center bg-bbaby-brighter">
          <div className="mx-6 box-border flex h-24 max-w-[1200px] grow flex-col justify-center px-4">
        ...
        <div className="mx-auto box-border flex max-w-[1248px] justify-center px-6 py-5 ">
          <LeaderboardMenu />
          {children}
          <div className="ml-8">
            <Widget>
