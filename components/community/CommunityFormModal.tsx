                ...
                <div className="max-h-[100%] max-w-[492px]">
                  ...
                  <div className="mb-[30px] flex flex-col" style={{ flexWrap: 'wrap' }}>
                    <div className="mb-[-4] mr-2 flex max-w-[100%] flex-col">
                      ...
                      <p className="text-[12px] leading-4 text-bbaby-text_darker">
                    ...
                    <div id="community name" className="mt-3 flex flex-grow flex-col items-start justify-end">
                      <span className="relative top-[26px] left-3 text-bbaby-text_darker">b/</span>
                      <input
                        value={name}
                        onChange={(ev) => setName(ev.target.value)}
                        className={`mb-2 box-border h-12 max-h-[37px] w-full rounded border border-bbaby-border bg-bbaby-brighter pt-1 pl-6 pb-1 pr-6 text-[14px] leading-[21px] md:text-[16px]`}
                        maxLength={21}
                        type={'text'}
                      />
                      <div className="mb-1 pt-1 text-xs text-bbaby-text_darker">21 Characters remaining</div>
                    </div>
                  </div>
