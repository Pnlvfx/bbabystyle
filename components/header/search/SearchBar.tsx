  ...
  return (
    <div id="searchDropdown" className="md:mx-4 ml-2 h-auto w-auto border border-transparent rounded relative min-w-[72px]">
      <div
        ...
        className={`flex items-center bg-reddit_dark-brightest border border-reddit_border h-[40px] hover:border-reddit_text rounded-[20px] ${
          modals.showSearch && "rounded-b-none border-reddit_text"
        }`}
      >
