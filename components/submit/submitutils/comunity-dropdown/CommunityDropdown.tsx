...
const CommunityDropdown = () => {
  ...
  const { selectedCommunity, initialCommunity } =
    useSubmitProvider();
      ...
      <ClickOutHandler onClickOut={closeDropdown}>
        <div
          className={`${style.dropdownContainer2} ${
            activeClass && style.opendropdownContainer2
          } lg:min-w-[300px]`}
        >
          <div
          ...
          {show && (
            ...
            >
              <div
                className={`solid max-h-[400px] overflow-y-scroll border border-reddit_border bg-reddit_dark-brighter`}
              >
                <div className="p-3 text-sm font-bold">
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      <p className="px-2 py-1 text-[13px] font-bold">
                        Create new
                      </p>
                    </button>
                  </div>
