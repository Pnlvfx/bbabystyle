            ...
            <div className={'absolute z-[11] w-full overflow-hidden bg-bbaby-brighter md:w-[300px]'}>
              <div className={`max-h-[400px] overflow-y-scroll border border-solid border-bbaby-border bg-bbaby-brighter`}>
                <div className="p-3 text-sm font-bold">
                  ...
                  {session?.user && (
                    <button className="my-1 flex w-full items-center space-x-2 hover:bg-bbaby-brightest">
                      <div className="overflow-hidden rounded-md border border-bbaby-border">
                  ...
                  <div className="flex items-center">
                    ...
                    <button onClick={openCommunityForm} className="ml-auto rounded-full hover:bg-bbaby-brightest">
