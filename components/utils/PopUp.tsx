...
const PopUp = ({ title, trigger, description, button1, button2 }: PopUpProps) => {
  return (
    <div className="fixed top-0 z-50 box-border flex h-full w-full items-center overflow-auto bg-[rgba(28,28,28,.4)] pt-[75px] pr-[30px] pb-5 pl-[30px]">
              ...
              <div className="max-h-[100%] max-w-[492px]">
                ...
                <div className="mb-[30px] flex flex-col" style={{ flexWrap: 'wrap' }}>
                  <div className="mb-[-4] mr-2 flex max-w-[100%] flex-col text-center">
                    <p className="text-[12px] whitespace-pre-wrap leading-4 text-bbaby-text_darker">
                      <span className="w-full">{description}</span>
                    </p>
                  </div>
                </div>
                <div className="mx-[-16px] mt-4 mb-[-16px] flex justify-center rounded-br bg-[#343536] p-4">
